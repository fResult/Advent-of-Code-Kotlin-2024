/**
 * [Day 4: xxxxx](https://adventofcode.com/2024/day/5)
 */
fun main() {
  val MAIN_INPUT_FILE = "Day05_test"
  val EXPECTED_PART_1_RESULT = 1
  val EXPECTED_PART_2_RESULT = 1
  val SAMPLE_INPUT_FILE = "Day05_sample"
  ...
  // Test if implementation meets criteria from the description (`src/Day05_sample.txt`), like:
